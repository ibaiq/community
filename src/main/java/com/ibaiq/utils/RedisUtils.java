...
public class RedisUtils {
     ...
     * @return
     */
    public Object hashGet(@NonNull String key, @NonNull String item) {
     ...
     * @return true或false
     */
    public boolean hashMapSet(String key, Map<String, Object> value) {
        try {
     ...
     * @param time  时间（秒）
     */
    public void hashMapSet(String key, Map<String, Object> value, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, value);
            if (time > 0) {
                expire(key, time);
     ...
     */
    public void hashDel(@NonNull String key, @NonNull Object... item) {
