...
public class SysConfigController extends BaseController {
    ...
    @GetMapping("/list")
    @PreAuthorize("@permission.hasPermits('sys:config:list')")
    ...
    @PutMapping
    @PreAuthorize("@permission.hasPermits('sys:config:modify')")
    ...
    @PostMapping
    @PreAuthorize("@permission.hasPermits('sys:config:save')")
